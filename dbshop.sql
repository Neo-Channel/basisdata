...
MySQL - 10.4.24-MariaDB : Database - dbshop
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`dbshop` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
insert  into `customers`(`customer_number`,`customer_name`,`contact_lastname`,`contact_firstname`,`phone`,`address_line1`,`address_line2`,`city`,`state`,`postal_code`,`country`,`sales_rep_employee_number`,`credit_limit`) values 
...
insert  into `employees`(`employee_number`,`lastname`,`firstname`,`extension`,`email`,`office_code`,`reports_to`,`job_title`) values 
...
insert  into `order_details`(`order_number`,`product_code`,`quantity_ordered`,`price_each`,`order_line_number`) values 
...
CREATE TABLE `product_lines` (
  `id_product_line` int(11) NOT NULL AUTO_INCREMENT,
...
insert  into `product_lines`(`id_product_line`,`product_line`,`text_description`,`html_description`,`image`) values 
...
(8,'Bicycle','Our bicycle are state of the art replicas of classic as well as contemporary motorcycle legends such as Harley Davidson, Ducati and Vespa. Models contain stunning details such as official logos, rotating wheels, working kickstand, front suspension, gear-shift lever, footbrake lever, and drive chain. Materials used include diecast and plastic. The models range in size from 1:10 to 1:50 scale and include numerous limited edition and several out-of-production vehicles. All models come fully assembled and ready for display in the home or office. Most include a certificate of authenticity.',NULL,NULL);
...
('S10_2016','1996 Moto Guzzi 1100i','2','1:10','Highway 66 Mini Classics','Official Moto Guzzi logos and insignias, saddle bags located on side of motorcycle, detailed engine, working steering, working suspension, two leather seats, luggage rack, dual exhaust pipes, small saddle bag located on handle bars, two-tone paint with chrome accents, superior die-cast detail , rotating wheels , working kick stand, diecast metal with plastic parts and baked enamel finish.',6625,68.99,118.94),
...
('S18_1662','1980s Black Hawk Helicopter','3','1:18','Red Start Diecast','1:18 scale replica of actual Army\'s UH-60L BLACK HAWK Helicopter. 100% hand-assembled. Features rotating rotor blades, propeller blades and rubber wheels.',5330,77.27,157.69),
...
('S18_4668','1939 Cadillac Limousine','7','1:18','Studio M Art Models','Features completely detailed interior including Velvet flocked drapes,deluxe wood grain floor, and a wood grain casket with seperate chrome handles',6645,23.14,50.31),
